...
pub use storage::{
    ...
    SBox, SMove, SMut, SOwned, SPinBox, SPinMut, SPinRef, SRef, SResult, State, StateInference,
    StateStorage, StateStorageNew, StateTransitionCall, StateUnionProofTransitionCall,
    StorageStateOwned, StorageStateOwnedBox, StorageStateOwnedPinBox, TransitionCallsite,
    TransitionEffect, TransitionEffectSelector, complete_transition_after_effect, pin_mut, pin_ref,
    proven_state, proven_union_state, transition_callsite, transition_concrete_after_effect,
